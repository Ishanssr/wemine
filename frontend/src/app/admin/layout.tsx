...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-cream-50">
      <div className="flex">
        <aside className="hidden md:flex w-64 min-h-screen flex-col glass-darker border-r border-white/40 p-4 pt-28 fixed left-0 top-0">
        ...
        <main className="flex-1 md:ml-64 pt-24 pb-16 px-6 md:px-10">
          {children}
        </main>
      </div>
    </div>
